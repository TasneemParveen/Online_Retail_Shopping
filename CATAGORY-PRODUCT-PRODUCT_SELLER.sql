...
--PLSQL BLOCK TO ADD/UPDATE PRODUCT AND PRODUCT_SELLER
DECLARE
    SELLER_ID1 VARCHAR2(20):= &ENTER_SELLER_ID;
    CATEGORY_ID1 NUMBER(10,0):= &ENTER_CATEGORY_ID;
    PRODUCT_NAME1 VARCHAR2(50 BYTE):= '&ENTER_PRODUCT_NAME';
    BRAND1 VARCHAR2(20):= '&BRAND';
    QUANTITY1 NUMBER:= '&QUANTITY';
    PRICE1 NUMBER:= '&ENTER_PRICE';
    DISCOUNT1 NUMBER:= '&ENTER_DISCOUNT';
    DISCOUNTED_PRICE1 NUMBER:= '&ENTER_DISCOUNTED_PRICE';
    DESCRIPTION1 VARCHAR2(100):= '&ENTER_DESCRIPTION';
